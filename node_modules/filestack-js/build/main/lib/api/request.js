...
var debug = debug_1.default('fs:request');
 ...
 * @param url
 */
exports.requestWithSource = function (retryConfig) {
    var axiosInstance = axios_1.default.create({
        headers: {
            'filestack-source': 'JS-3.3.4',
            'filestack-trace-id': Math.floor(Date.now() / 1000) + "-" + utils_1.uniqueId(),
            'filestack-trace-span': "jssdk-" + utils_1.uniqueId(),
        },
    });
    if (retryConfig) {
        exports.useRetryPolicy(axiosInstance, retryConfig);
    }
    useDebugInterceptor(axiosInstance);
    return axiosInstance;
};
exports.postWithRetry = function (url, fields, config, retryConfig) {
...
exports.useRetryPolicy = function (instance, retryConfig) {
...
useDebugInterceptor(axios_1.default);
