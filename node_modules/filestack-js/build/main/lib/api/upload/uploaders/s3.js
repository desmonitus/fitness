...
var S3Uploader = /** @class */ (function (_super) {
    ...
    S3Uploader.prototype.getStoreOptions = function () {
        return tslib_1.__assign({ location: abstract_1.DEFAULT_STORE_LOCATION }, this.storeOptions);
    };
    /**
    ...
    S3Uploader.prototype.getDefaultFields = function (id, requiredFields, fiiFallback) {
        ...
        return tslib_1.__assign({}, utils_1.filterObject(fields, requiredFields), { store: this.getStoreOptions() });
    };
    /**
    ...
    S3Uploader.prototype.startRequest = function (id) {
        ...
        return request_1.postWithRetry(this.getUrl() + "/multipart/start", tslib_1.__assign({ filename: payload.file.name, mimetype: payload.file.type, size: payload.file.size }, this.getDefaultFields(id, ['apikey', 'policy', 'signature', 'fii'], true)), {
            ...
            _this.setPayloadStatus(id, "Failed" /* FAILED */);
            return Promise.reject(new filestack_error_1.FilestackError('Cannot upload file', err.data, filestack_error_1.FilestackErrorType.REQUEST));
        });
    };
    /**
    ...
    S3Uploader.prototype.getS3PartMetadata = function (id, part, offset) {
        ...
        return request_1.postWithRetry(url + "/multipart/upload", tslib_1.__assign({}, this.getDefaultFields(id, ['apikey', 'uri', 'region', 'signature', 'policy', 'upload_id', 'fii']), { 
            ...
            _this.setPayloadStatus(id, "Failed" /* FAILED */);
            return Promise.reject(new filestack_error_1.FilestackError('Cannot get part metadata', err.data, filestack_error_1.FilestackErrorType.REQUEST));
        });
    };
    /**
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, request_1.request
                                ...
                                return Promise.reject(new filestack_error_1.FilestackError('Cannot upload file part', err.data, filestack_error_1.FilestackErrorType.REQUEST));
                            })];
                }
            });
        });
    ...
    S3Uploader.prototype.completeRequest = function (id) {
        ...
        return request_1.postWithRetry(this.getUrl() + "/multipart/complete", tslib_1.__assign({}, this.getDefaultFields(id, ['apikey', 'policy', 'signature', 'uri', 'region', 'upload_id', 'fii'], true), { 
            ...
            .catch(function (err) {
            _this.setPayloadStatus(id, "Failed" /* FAILED */);
            return Promise.reject(new filestack_error_1.FilestackError('Cannot complete file', err.data, filestack_error_1.FilestackErrorType.REQUEST));
        });
    };
    /**
