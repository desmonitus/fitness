...
exports.isMobile = function () { return !exports.isNode() && navigator && navigator.userAgent && mobileRegexp.test(navigator.userAgent); };
/**
 * Returns unique time
 */
var last;
...
exports.md5 = function (data) {
    if (exports.isNode()) {
        return (exports.requireNode('crypto')).createHash('md5').update(data).digest('base64');
    }
    /* istanbul ignore next */
 ...
 * @param {string} name
 */
exports.requireNode = function (name) {
    if (!exports.isNode()) {
        return false;
    }
