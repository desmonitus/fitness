...
})(AlignOptions = exports.AlignOptions || (exports.AlignOptions = {}));
/**
...
})(AlignFacesOptions = exports.AlignFacesOptions || (exports.AlignFacesOptions = {}));
/**
 * Fit enum
 */
var FitOptions;
    ...
    Filelink.prototype.toString = function () {
        ...
        if (this.b64) {
            if (this.transforms.length > 0) {
                transformsString = "b64/" + utils_1.b64(JSON.stringify(this.transforms));
            }
            if (Array.isArray(source)) {
                source = this.arrayToString(source);
            }
            source = "b64://" + utils_1.b64(source);
        }
        else {
            if (Array.isArray(source)) {
                source = this.arrayToString(source);
