 ...
 */
export declare const isNode: () => string;
/**
 ...
 */
export declare const getMimetype: (file: Uint8Array | Buffer) => string;
/**
 * return based string
 * @param data
 */
export declare const b64: (data: string) => string;
/**
 * Hides require from buindling by weback to browser
 *
 * @param {string} name
 */
export declare const requireNode: (name: string) => any;
/**
 * Sanitizer Options
 */
 ...
 */
export declare const sanitizeName: (name: string, options?: boolean | {
    exclude?: string[];
    replacement?: string;
}) => string;
/**
